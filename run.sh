...
# Export REDIS_URL for the Redis instance
export REDIS_URL="valkeys://$VALKEY_USERNAME_REOPS_UMAMI_BETA:$VALKEY_PASSWORD_REOPS_UMAMI_BETA@$VALKEY_HOST_REOPS_UMAMI_BETA:$VALKEY_PORT_REOPS_UMAMI_BETA"
