...
export DATABASE_URL="postgresql://$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_USERNAME:$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_PASSWORD@$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_HOST:$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_PORT/umami-one?sslidentity=/tmp/client-identity.p12&sslpassword=$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_PASSWORD&sslcert=$NAIS_DATABASE_REOPS_UMAMI_BETA_REOPS_UMAMI_BETA_SSLROOTCERT&statement_timeout=60000" || echo "Failed to set DATABASE_URL" >> /tmp/run_error.log
